...
public class DummyMovieDataProviderImpl implements MovieDataProvider {
	...
	private static final List<Movie> listOfAlienMovies() {
		...
		movies.add(createSimpleMovie("Alien", "1979", "tt0078748", "movie",
		...
		movies.add(createSimpleMovie("Alien 3", "1992", "tt0103644", "movie",
		...
		movies.add(createSimpleMovie("Alien: Resurrection", "1997", "tt0118583", "movie",
		...
		movies.add(createSimpleMovie("AVP: Alien vs. Predator", "2004", "tt0370263", "movie",
	...
	private static final Movie barryLyndonMovie() {
		...
		return createMovie("Barry Lyndon", "1975", "tt0072684", "movie",
	...
	private static final List<Movie> listOfBarryLyndonMovie() {
		...
		movies.add(createSimpleMovie("Barry Lyndon", "1975", "tt0072684", "movie",
				"https://images-na.ssl-images-amazon.com/images/M/MV5BNmY0MWY2NDctZDdmMi00MjA1LTk0ZTQtZDMyZTQ1NTNlYzVjXkEyXkFqcGdeQXVyMjUzOTY1NTc@._V1_SX300.jpg"));
		return movies;

	}

	private static final Movie createSimpleMovie(String title, String year, String id, String type, String poster) {
	...
	private static final Movie createMovie(String title, String year, String id, String type, String poster,
